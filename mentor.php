...
<style>
      .container {
            ...
            margin: auto;
            padding-top: 50px;
            background-image: url('https://tse1.mm.bing.net/th?id=OIP.UA5jZDW6wLZQ6PrlQOkzpwAAAA&pid=Api&P=0&h=180');
...
<div class="container">
    <div id="header">
        <h1>Welcome to the mentor Page</h1>
...
$excludedTables = array("mentor_details", "program_applications", "program_participants");
